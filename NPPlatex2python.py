...
ops =  {
        ...
        r'\\cos' : 'math.cos',
        r'\\tan' : 'math.tan',
        r'\\arcsin' : 'math.arcsin',
        r'\\arccos' : 'math.arccos',
        r'\\arctan' : 'math.arctan',
        r'\\sinh' : 'math.sinh',
        r'\\cosh' : 'math.cosh',
        r'\\tanh' : 'math.tanh',
        r'\\sqrt' : 'math.sqrt',
...
def repFunctions(f, s):
    ...
    if f == r'\\log_':
        while True:
            ...
            s = s[:i] + '(math.log('+arg+')/math.log('+base+'))' + s_strip[pos+1:]
...
def main():
    ...
    def getMultiLines(contents, lineNumber, totalLines):
        ...
        editor.replaceWholeLine(lineNumber, s)
    editor.forEachLine(getMultiLines)
